...
import { Download, Loader2, ClipboardCheck, Calculator, Ruler, Sparkles, Truck, Tags, QrCode, Package } from "lucide-react";
  ...
  return (
    <Layout>
      ...
      <div className="p-4 sm:p-6 lg:p-8 max-w-5xl">
        ...
        <div className={`${cardClass} p-5 sm:p-6 mb-4 sm:mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-3`} data-testid="form-card-packages">
          <div className="flex items-start gap-3">
            <div className="w-11 h-11 bg-primary/15 border border-primary/40 rounded-none flex items-center justify-center">
              <Package className="w-6 h-6 text-primary" />
            </div>
            <div>
              <h3 className="font-display font-bold text-lg uppercase tracking-wide leading-tight">DOT / Owner package</h3>
              <p className="text-sm text-muted-foreground mt-1">One-click pour packet — QIR, tension, strength, finish, pre-delivery, heats, drawings. PDF + Excel, stored on the pour.</p>
            </div>
          </div>
          <Link to="/packages" className="min-h-12 px-4 bg-primary text-white font-display font-bold uppercase tracking-widest flex items-center justify-center">Open</Link>
        </div>
